  ...
  return (
    <section className="relative overflow-hidden border-b border-white/10 pt-40">
      ...
      <Container className="relative">
        ...
        <p
          className="horizons-faq-in mt-9 max-w-2xl text-[15px] leading-8 text-white/60 md:text-[17px] md:leading-9"
      ...
      <div className="mt-16 md:mt-24">
        ...
        <Container>
          <div
            className="horizons-faq-in flex flex-col gap-8 py-10 md:flex-row md:items-start md:gap-16 md:py-12"

type ExperienceCardProps = {
  ...
  export default function ExperienceCard({
    ...
    return (
        <article className="group rounded-3xl py-4 transition-all duration-500 hover:-translate-y-1">
        {/* Category */}
        ...
        {/* Heading */}
        <h3 className="mt-4 max-w-[320px] font-serif text-[40px] leading-[1.08] tracking-[-0.03em] text-neutral-900 transition-colors duration-300 group-hover:text-neutral-700">
          {subtitle}
        </h3>
        ...
        {/* CTA */}
        <button className="group/button mt-10 inline-flex items-center gap-3 text-[13px] font-medium uppercase tracking-[0.3em] text-neutral-700 transition-colors duration-300 hover:text-neutral-900">

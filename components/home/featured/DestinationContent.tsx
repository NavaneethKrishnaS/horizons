...
export default function DestinationContent({
  ...
  // Keyed on the title so React remounts this when the destination changes,
  // which replays the entrance. Deliberately no AnimatePresence: its "wait"
  // mode holds the old content until the exit animation finishes, and a few
  // quick changes in a row left it stuck on the previous destination.
  return (
    <motion.div
      key={title}

...
/*
  ...
  The page used to be completely static apart from WhereWeComeFrom, which
  has a pinned photograph and a parallax — so the one elaborate thing on
  the page sat between six sections that did nothing, and read as the only
  finished part of it rather than as the centrepiece. The reveal is the
  same one the rest of the site uses, and it stands down for anyone who

...
export const KERALA: Destination[] = [
  {
    ...
    standfirst: "Where the state governs itself, and where its cliffs fall into the sea.",
    body: [
    ...
    season: "November to March. April and May are hot, and the sea is warm enough to forgive it.",
    nights: "Three at the end of a journey.",
    arrive: "Trivandrum airport to Kovalam, 15km, half an hour. Varkala is an hour north of the airport.",
    collection: "coast",
    stays: ["villa-jacaranda"],
    routeStops: ["Trivandrum", "Kovalam", "Poovar"],
    image: {
      src: "/images/stays/villa-jacaranda/cover.webp",
      alt: "Villa Jacaranda on the Varkala cliff",
    },
  },
  {
    id: "kollam",
    ...
    standfirst: "Eight creeks, a sinking island, and the village where the houseboat was invented.",
    body: [
    ...
    season: "November to March. Come out of the monsoon and the canals are at their fullest.",
    nights: "One or two, usually on the way between Trivandrum and the backwaters.",
    arrive: "Kollam is an hour and a half south of Alappuzha and two hours north of Trivandrum airport.",
    collection: "backwaters",
    stays: [],
    routeStops: ["Munroe Island", "Alumkadavu"],
    image: {
      src: `${UNSPLASH}/photo-1583482011546-c327a8076798?auto=format&fit=crop&w=1400&q=70`,
      alt: "Sunrise at Munroe Thuruthu, a boatman poling through the canals",
  ...
  },
  {
    ...
    standfirst: "Pilgrim country, snake boats, and the road up into the reserve.",
    body: [
    ...
    season: "September to March. Onam, in August or September, is when the boats race.",
    nights: "A day on the way between the backwaters and the hills, or a night at Gavi.",
    arrive: "Aranmula is an hour and a half from Alappuzha. Gavi is four hours from Kochi airport.",
    collection: "hills",
    stays: [],
    routeStops: [],
  },
  {
    ...
    standfirst: "Vembanad, the canals that feed it, and the beach on the other side of the road.",
    body: [
    ...
    arrive: "Cochin airport to Alappuzha, 85km, about two hours. The train from Ernakulam does it in forty minutes.",
    collection: "backwaters",
    stays: ["spice-coast-cruises", "purity", "marari-villas", "marari-beach-resort"],
    routeStops: ["Alleppey", "The backwaters", "Mararikulam", "Arattupuzha"],
    boats: true,
    image: {
      src: "/images/stays/spice-coast-cruises/cover.webp",
  ...
  },
  {
    ...
    standfirst: "The quiet side of the same lake, and the rubber country behind it.",
    body: [
    ...
    image: {
      src: "/images/stays/philipkuttys-farm/cover.webp",
      alt: "Philipkutty's Farm on Lake Vembanad, near Kumarakom",
    },
  },
  {
    id: "idukki",
    ...
    standfirst: "Tea to the horizon, cardamom under it, and a lake with a forest around it.",
    body: [
    ...
    arrive: "Cochin airport to Munnar, 110km, three and a half hours — a slow, climbing road, and the drive is part of it. Thekkady is three hours on from Munnar.",
    collection: "hills",
    stays: ["windermere-estate", "shalimar-spice-garden"],
    routeStops: ["Munnar", "Thekkady", "Periyar"],
    image: {
      src: "/images/stays/windermere-estate/cover.webp",
      alt: "Windermere Estate above the tea at Munnar",
    },
  },
  {
    id: "ernakulam",
    ...
    body: [
      ...
      "The Chinese fishing nets on the seafront, the synagogue and the spice warehouses in Mattancherry, Portuguese houses with the paint coming off them, and a coffee at four while the cargo ships queue outside. In the evening there is Kathakali, and if you have never seen it, see it.",
    ...
    collection: "kochi",
    stays: ["malabar-house", "old-harbour-hotel", "tea-bungalow", "the-old-courtyard-hotel", "gramam-homestay", "cranganor"],
    routeStops: ["Kochi", "Fort Kochi"],
    image: {
      src: "/images/stays/malabar-house/cover.webp",
      alt: "Malabar House in Fort Kochi",
    },
  },
  {
    id: "thrissur",
    ...
    season: "The falls are best from September to December. The Pooram is April or May, and the town is full.",
    nights: "A day from Kochi, or a night if you are going to the falls properly.",
    arrive: "Athirappilly is two hours from Cochin airport; Thrissur town an hour and a half.",
    collection: "kochi",
    stays: [],
    routeStops: [],
    image: {
      src: `${UNSPLASH}/photo-1575305327780-a887f284432f?auto=format&fit=crop&w=1400&q=70`,
  ...
  },
  {
    ...
    standfirst: "The one break in the Western Ghats, and the paddy that grows because of it.",
    body: [
    ...
    arrive: "Two and a half hours from Cochin airport, and the road to Coimbatore runs through it.",
    collection: "hills",
    stays: [],
    routeStops: [],
    image: {
      src: `${UNSPLASH}/photo-1662535330891-877130e86a23?auto=format&fit=crop&w=1400&q=70`,
      alt: "Paddy fields and hills at Akathethara, Palakkad",
      credit: "Hariprasad B",
    },
  },
  {
    ...
    standfirst: "The oldest teak plantation in the world, and the Malabar kitchen.",
    body: [
    ...
    arrive: "Kozhikode airport is in the district, forty minutes from Nilambur.",
    collection: "coast",
    stays: [],
    routeStops: [],
  },
  {
    ...
    standfirst: "Where Vasco da Gama landed, and where the dhows are still built.",
    body: [
    ...
    arrive: "Kozhikode airport is forty minutes from the city; Wayanad is two and a half hours up the ghat.",
    collection: "coast",
    stays: [],
  ...
  },
  {
    ...
    district: "Wayanad",
    name: "The plateau",
    standfirst: "Up the ghat road into coffee, and the oldest human marks in the state.",
    body: [
    ...
    nights: "Two.",
    arrive: "Kozhikode airport to Wayanad, 95km, two and a half hours up the ghat road.",
    collection: "hills",
    stays: [],
    routeStops: ["Wayanad"],
    image: {
      src: `${UNSPLASH}/photo-1607025188828-be77a08aa372?auto=format&fit=crop&w=1400&q=70`,
      alt: "Banasura Sagar reservoir and the hills of Wayanad",
      credit: "Jyoti Singh",
    },
  },
  {
    ...
    arrive: "Kannur has its own international airport, twenty minutes from the town.",
    collection: "coast",
    stays: [],
    routeStops: ["Kannur", "Thalassery", "The Malabar coast"],
    image: {
      src: `${UNSPLASH}/photo-1551292083-5d458a10336d?auto=format&fit=crop&w=1400&q=70`,
      alt: "A Theyyam performer being dressed in north Malabar",
  ...
  },
  {
    ...
    standfirst: "The last district before Karnataka, and the emptiest coast in the state.",
    body: [
    ...
    arrive: "Kannur airport to Bekal, 75km, two hours. Mangalore airport is an hour and a half away.",
    collection: "coast",
    stays: ["neeleshwar-hermitage"],
    routeStops: [],
    image: {
      src: "/images/stays/neeleshwar-hermitage/cover.webp",
      alt: "Neeleshwar Hermitage on the Malabar coast",
    },
  },
];
